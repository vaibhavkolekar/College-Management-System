...
public class register extends AppCompatActivity {
    ...
    EditText name1,email1,dob1,mobile1,pass1,confirmpass1,prn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        prn=findViewById(R.id.editText_register_PRN);
        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String PRN = prn.getText().toString();
                String textgender;
                ...
                if (TextUtils.isEmpty(name)){
                    ...
                    registeruser(name,email,dob,textgender,mobile,pass, PRN);
                }
            }
        });
    }

    private void registeruser(String name, String email, String dob, String gender, String mobile, String pass, String PRN) {
                ...
                new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful()){
                            ...
                            readwriteUserDetails writeUserDetails =new readwriteUserDetails(dob,gender,mobile,email,PRN, name);
